  ...
  <div class="app-sidebar-menu overflow-hidden flex-column-fluid">
    ...
    >
      ...
      >
        ...
        <!-- Section Help (Components, Documentation, Changelog) DIHAPUS -->
      </div>
      <!--end::Menu-->
    </div>
    <!--end::Menu wrapper-->
...
export default defineComponent({
  ...
  setup() {
    ...
    const hasActiveChildren = (match: string) => route.path.indexOf(match) !== -1;

    return { hasActiveChildren, MainMenuConfig, sidebarMenuIcons, translate, getAssetPath };
  },
});
</script>