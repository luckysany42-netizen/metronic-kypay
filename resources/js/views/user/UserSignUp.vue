  ...
  <div class="w-lg-460px px-10 py-12">
    ...
    >
      ...
      <div class="fv-row mb-5">
        <label class="form-label fw-semibold fs-7 text-gray-700 mb-2">Nomor HP <span class="text-danger">*</span></label>
        ...
        <div class="text-muted fs-8 fw-semibold mt-1">Nomor ini akan digunakan untuk login</div>
        <div class="fv-plugins-message-container mt-1">
...
export default defineComponent({
  ...
  setup() {
    ...
    onMounted(() => {
      nextTick(() => { PasswordMeterComponent.bootstrap(); });
    });
    ...
    return {
      registration, onSubmitRegister, submitButton,
      showPassword, showPasswordConfirm, getAssetPath,
    };
  },
});
</script>
